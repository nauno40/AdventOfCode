...
final class Day1 extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('The result 1 is: ' . $output1);
        $output->writeln('The result 2 is: ' . $output2);


        return self::SUCCESS;
    }

    private function getIntegerFromFirstAndLastDigit(string $str): int
    {
    ...
    private function convertSpelledOutNumbersToNumbers(string $str): string
    {
